Это собственный проект, на данный момент находится в разработке. План доработки: написать скрипт, записывающий данные с вопросами в БД; сделать интерактивные кнопки.
# **FAQ's** 
